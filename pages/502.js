...
export default function FiveOhTwo() {
    return (
        <div>
            ...
            <Text m={4}>If this keeps happening/doesn&apos;t come back in at least an hour, please <Link colorScheme="blue" variant="solid" as={Link} href="mailto:hi@odyssey346.dev?subject=Your (enter service here) instance is down.">send me an E-mail. <ExternalLinkIcon /></Link></Text>
